        ...
        for batch in &batches {
            ...
            for i in 0..batch.num_rows() {
                ...
                let payload: serde_json::Value =
                    serde_json::from_str(payloads.value(i)).map_err(MemoryError::Json)?;
...
mod tests {
    ...
    async fn lancedb_upsert_and_search() {
        ...
        let store = LanceDBStore::new(dir.path().to_str().unwrap(), "test", 4)
            .await
            .unwrap();
