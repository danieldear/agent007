...
pub use repo_index::{
    ...
    evidence_refs_for_text_index, freshen_index_if_needed, index_is_stale, index_path_for_graph_path,
    index_status, load_or_build_index, open_index_for_graph_path, save_index, RepoIndex,
    RepoIndexFreshenReport, RepoIndexStatus,
};
