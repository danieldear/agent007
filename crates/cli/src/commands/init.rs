...
steps:
  - id: find-errors
    ...
    prompt: |
      Operating protocol:
      - Use repository, memory, and prior-step context before making broad claims.
      ...
      - Separate evidence from inference; cite files, commands, outputs, sources, or upstream step IDs.
